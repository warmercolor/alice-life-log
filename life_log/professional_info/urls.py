...
from .views import EducationView, CourseView, JobView, TechnologyView, ProfessionalSummaryView
...
urlpatterns = [
    ...
    path('professional-summary/', ProfessionalSummaryView.as_view(), name='professional-summary'),
]
